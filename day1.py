...
mysqldb=mysql.connector.connect(host='localhost',user='root',password="x1carbon")
mycursor = mysqldb.cursor()
try:
    mycursor.execute('create database demo')
except:
    print('DB already exists')
    mysqldb=mysql.connector.connect(host="localhost",user="root",password="x1carbon",database="demo")
mycursor = mysqldb.cursor()
try:
